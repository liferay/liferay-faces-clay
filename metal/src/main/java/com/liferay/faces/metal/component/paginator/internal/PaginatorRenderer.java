 ...
 * details.
 */
package com.liferay.faces.metal.component.paginator.internal;
...
import com.liferay.faces.metal.component.paginator.Paginator;
...
public class PaginatorRenderer extends PaginatorRendererBase implements ComponentSystemEventListener {
	...
	public void decode(FacesContext facesContext, UIComponent uiComponent) {
		...
		if (uiData != null) {
			...
			logger.error(
				"The metal:paginator must have it's for attribute set or it must be inside of an f:facet of an metal:dataTable or metal:dataList");
		}
	}
	...
	public void encodeBegin(FacesContext facesContext, UIComponent uiComponent) throws IOException {
		...
		// Encode the starting <div> element that represents the metal:paginator.
		Paginator paginator = (Paginator) uiComponent;
	...
	public void encodeEnd(FacesContext facesContext, UIComponent uiComponent) throws IOException {
		...
		// Encode the closing </div> element that represents the metal:paginator.
		ResponseWriter responseWriter = facesContext.getResponseWriter();
		responseWriter.endElement("div");
	}
	...
	protected void encodeUnorderedListItem(FacesContext facesContext, ResponseWriter responseWriter,
		...
		if (enabled) {
			...
			// If the metal:paginator has a nested f:ajax tag, then encode a hyperlink that contains the client
