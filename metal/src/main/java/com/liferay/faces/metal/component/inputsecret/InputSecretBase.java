 ...
 * details.
 */
package com.liferay.faces.metal.component.inputsecret;
//J-
...
public abstract class InputSecretBase extends HtmlInputSecret implements Styleable {
	...
	// Public Constants
	public static final String COMPONENT_TYPE = "com.liferay.faces.metal.component.inputsecret.InputSecret";
	public static final String RENDERER_TYPE = "com.liferay.faces.metal.component.inputsecret.InputSecretRenderer";
	...
	public String getStyleClass() {
		...
		return com.liferay.faces.util.component.ComponentUtil.concatCssClasses(styleClass, "metal-input-secret", "form-control");
	}
}
//J+
