 ...
 * details.
 */
package com.liferay.faces.metal.component.datalist.internal;
...
import com.liferay.faces.metal.component.dataitem.DataItem;
import com.liferay.faces.metal.component.datalist.DataList;
		...
		// Otherwise, encode content for each child of the specified dataList.
			...
			for (int i = 0; i < childCount; i++) {
				...
				if (child.isRendered() && (child instanceof DataItem)) {
					...
					logger.warn("Unable to render child element of metal:dataList since it is not metal:dataItem");
				}
			}
		}
