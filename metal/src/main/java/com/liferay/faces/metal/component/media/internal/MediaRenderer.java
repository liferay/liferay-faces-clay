...
public abstract class MediaRenderer extends MediaRendererCompat {
	...
	public void encodeChildren(FacesContext facesContext, UIComponent uiComponent) throws IOException {
		...
		for (UIComponent child : children) {
			...
			if (child instanceof com.liferay.faces.metal.component.resource.Resource) {

				String mediaResourceURL;
				com.liferay.faces.metal.component.resource.Resource resource =
					(com.liferay.faces.metal.component.resource.Resource) child;
		...
		if (firstMediaResourceURL == null) {
			logger.warn("No {0} has been specified for <metal:{0} id=[{1}] />.", getMediaType(), media.getClientId());
		}
	...
	protected void encodeFlashPlayer(FacesContext facesContext, ResponseWriter responseWriter, Media media,
		...
		// Otherwise, get the default Metal Flash player.
		else {
