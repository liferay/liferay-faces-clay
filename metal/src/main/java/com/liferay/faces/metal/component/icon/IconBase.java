 ...
 * details.
 */
package com.liferay.faces.metal.component.icon;
//J-
...
public abstract class IconBase extends UIComponentBase implements Styleable {
	...
	// Public Constants
	public static final String COMPONENT_FAMILY = "com.liferay.faces.metal.component.icon";
	public static final String COMPONENT_TYPE = "com.liferay.faces.metal.component.icon.Icon";
	public static final String RENDERER_TYPE = "com.liferay.faces.metal.component.icon.IconRenderer";
	...
	public String getStyleClass() {
		...
		return com.liferay.faces.util.component.ComponentUtil.concatCssClasses(styleClass, "metal-icon");
	}
