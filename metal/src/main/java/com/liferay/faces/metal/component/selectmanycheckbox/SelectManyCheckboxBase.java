 ...
 * details.
 */
package com.liferay.faces.metal.component.selectmanycheckbox;
//J-
...
public abstract class SelectManyCheckboxBase extends HtmlSelectManyCheckbox implements Styleable {
	...
	// Public Constants
	public static final String COMPONENT_TYPE = "com.liferay.faces.metal.component.selectmanycheckbox.SelectManyCheckbox";
	public static final String RENDERER_TYPE = "com.liferay.faces.metal.component.selectmanycheckbox.SelectManyCheckboxRenderer";
	...
	public String getStyleClass() {
		...
		return com.liferay.faces.util.component.ComponentUtil.concatCssClasses(styleClass, "metal-select-many-checkbox", "checkbox");
	}
}
//J+
