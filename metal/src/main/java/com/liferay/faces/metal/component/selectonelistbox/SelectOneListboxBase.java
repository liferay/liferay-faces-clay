 ...
 * details.
 */
package com.liferay.faces.metal.component.selectonelistbox;
//J-
...
public abstract class SelectOneListboxBase extends HtmlSelectOneListbox implements Styleable {
	...
	// Public Constants
	public static final String COMPONENT_TYPE = "com.liferay.faces.metal.component.selectonelistbox.SelectOneListbox";
	public static final String RENDERER_TYPE = "com.liferay.faces.metal.component.selectonelistbox.SelectOneListboxRenderer";
	...
	public String getStyleClass() {
		...
		return com.liferay.faces.util.component.ComponentUtil.concatCssClasses(styleClass, "metal-select-one-listbox");
	}
}
//J+
