 ...
 * details.
 */
package com.liferay.faces.metal.component.column;
//J-
...
public abstract class ColumnBase extends HtmlColumn implements Styleable {
	...
	// Public Constants
	public static final String COMPONENT_TYPE = "com.liferay.faces.metal.component.column.Column";
	public static final String RENDERER_TYPE = "com.liferay.faces.metal.component.column.ColumnRenderer";
	 ...
	 *
	 * <div>When metal:column is a child of metal:dataTabe, this is the JavaBean property that is to be used for filtering.</div>
	 */
	 ...
	 *
	 * <div>When metal:column is a child of metal:dataTable, this is the text for the column header. This attribute can be used as a convenience instead of specifying a child <code>&lt;f:facet name="header" /&gt;</code> tag.</div>
	 */
	 ...
	 *
	 * <div>When metal:column is a child of metal:dataTabe, this is the JavaBean property that is to be used for sorting.</div>
	 */
	...
	public String getStyleClass() {
		...
		return com.liferay.faces.util.component.ComponentUtil.concatCssClasses(styleClass, "metal-column");
	}
