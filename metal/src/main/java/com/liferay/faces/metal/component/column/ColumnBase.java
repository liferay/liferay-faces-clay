...
public abstract class ColumnBase extends HtmlColumn implements Styleable {
	 ...
	 * <br /><br />
	 * When metal:column is a child of metal:dataTabe, this is the JavaBean property that is to be used for filtering.
	 */
	 ...
	 * <br /><br />
	 * When metal:column is a child of metal:dataTable, this is the text for the column header. This attribute can be used as a convenience instead of specifying a child <code>&lt;f:facet name="header" /&gt;</code> tag.
	 */
	 ...
	 * <br /><br />
	 * When metal:column is a child of metal:dataTabe, this is the JavaBean property that is to be used for sorting.
	 */
