 ...
 * details.
 */
package com.liferay.faces.metal.component.selectbooleancheckbox;
//J-
...
public abstract class SelectBooleanCheckboxBase extends HtmlSelectBooleanCheckbox implements Styleable {
	...
	// Public Constants
	public static final String COMPONENT_TYPE = "com.liferay.faces.metal.component.selectbooleancheckbox.SelectBooleanCheckbox";
	public static final String RENDERER_TYPE = "com.liferay.faces.metal.component.selectbooleancheckbox.SelectBooleanCheckboxRenderer";
	...
	public String getStyleClass() {
		...
		return com.liferay.faces.util.component.ComponentUtil.concatCssClasses(styleClass, "metal-select-boolean-checkbox");
	}
}
//J+
