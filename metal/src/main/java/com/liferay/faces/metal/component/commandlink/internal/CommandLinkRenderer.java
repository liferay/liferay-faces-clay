 ...
 * details.
 */
package com.liferay.faces.metal.component.commandlink.internal;
...
public class CommandLinkRenderer extends CommandLinkRendererBase implements ComponentSystemEventListener {
	...
	public void processEvent(ComponentSystemEvent componentSystemEvent) throws AbortProcessingException {
		...
		if (commandLink.isAjax()) {
			MetalRendererUtil.addDefaultAjaxBehavior(commandLink, commandLink.getExecute(), commandLink.getProcess(),
