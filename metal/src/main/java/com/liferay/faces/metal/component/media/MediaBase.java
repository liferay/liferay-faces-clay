 ...
 * details.
 */
package com.liferay.faces.metal.component.media;
//J-
...
public abstract class MediaBase extends UIComponentBase {
	...
	// Public Constants
	public static final String COMPONENT_FAMILY = "com.liferay.faces.metal.component.media";
	public static final String COMPONENT_TYPE = "com.liferay.faces.metal.component.media.Media";
	public static final String RENDERER_TYPE = "com.liferay.faces.metal.component.media.MediaRenderer";
	 ...
	 *
	 * <div>A context-relative path, resource URL, or FacesResource that can be used to retrieve the Adobe&reg; Flash&reg; player. The default flash player is the flash player bundled with MetalJS. <strong>Note:</strong> The MetalJS player does not support <code>.ogv</code> or <code>.webm</code> formats.</div>
	 */
