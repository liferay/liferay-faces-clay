 ...
 * details.
 */
package com.liferay.faces.metal.component.selectoneradio;
//J-
...
public abstract class SelectOneRadioBase extends HtmlSelectOneRadio implements Styleable {
	...
	// Public Constants
	public static final String COMPONENT_TYPE = "com.liferay.faces.metal.component.selectoneradio.SelectOneRadio";
	public static final String RENDERER_TYPE = "com.liferay.faces.metal.component.selectoneradio.SelectOneRadioRenderer";
	...
	public String getStyleClass() {
		...
		return com.liferay.faces.util.component.ComponentUtil.concatCssClasses(styleClass, "metal-select-one-radio", "radio");
	}
}
//J+
