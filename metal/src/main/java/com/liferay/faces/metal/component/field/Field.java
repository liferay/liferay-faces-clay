...
import com.liferay.faces.metal.component.selectbooleancheckbox.SelectBooleanCheckbox;
...
public class Field extends FieldBase {
	...
	public String getStyleClass() {
		...
		return ComponentUtil.concatCssClasses(styleClass, "metal-field", controlGroupCssClass);
	}
