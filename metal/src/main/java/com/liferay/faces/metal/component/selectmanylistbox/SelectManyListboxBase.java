 ...
 * details.
 */
package com.liferay.faces.metal.component.selectmanylistbox;
//J-
...
public abstract class SelectManyListboxBase extends HtmlSelectManyListbox implements Styleable {
	...
	// Public Constants
	public static final String COMPONENT_TYPE = "com.liferay.faces.metal.component.selectmanylistbox.SelectManyListbox";
	public static final String RENDERER_TYPE = "com.liferay.faces.metal.component.selectmanylistbox.SelectManyListboxRenderer";
	...
	public String getStyleClass() {
		...
		return com.liferay.faces.util.component.ComponentUtil.concatCssClasses(styleClass, "metal-select-many-listbox");
	}
}
//J+
