 ...
 * details.
 */
package com.liferay.faces.metal.component.panel.internal;
...
import com.liferay.faces.metal.component.panel.Panel;
...
public class PanelRenderer extends PanelRendererBase {
	...
	public void encodeBegin(FacesContext facesContext, UIComponent uiComponent) throws IOException {
		...
		if ((headerFacet != null) || (headerText != null)) {
			...
			responseWriter.writeAttribute("class", "metal-panel-heading", null);
			...
			if (headerFacet != null) {
				...
				responseWriter.writeAttribute("class", "metal-panel-title", null);
		...
		responseWriter.startElement("div", uiComponent);
		responseWriter.writeAttribute("class", "metal-panel-body", null);
	}
	...
	public void encodeEnd(FacesContext facesContext, UIComponent uiComponent) throws IOException {
		...
		if ((footerFacet != null) || (footerText != null)) {
			responseWriter.startElement("div", uiComponent);
			responseWriter.writeAttribute("class", "metal-panel-footer", null);
