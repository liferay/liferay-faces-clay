 ...
 * @author  Neil Griffin
 */
public class MessageContextFactoryCrystalShowcaseImpl extends MessageContextFactory {

	// Private Data Members
	private MessageContextFactory wrappedMessageContextFactory;
	private MessageContext messageContext;

	public MessageContextFactoryCrystalShowcaseImpl(MessageContextFactory messageContextFactory) {
		...
		this.messageContext = new MessageContextCrystalShowcaseImpl(wrappedMessageContext);
	}
