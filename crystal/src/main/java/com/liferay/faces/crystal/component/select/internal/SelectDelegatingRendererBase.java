...
/**
 * In order to render crystal:selectManyCheckbox and crystal:selectOneRadio using CSS classes and elements consistent
 * with Liferay Portal's (and CrystalUI's) style, SelectDelegatingRendererBase replaces the default ResponseWriter with
 * {@link TableSuppressingResponseWriter} and {@link LabelSurroundingResponseWriter}. This class is designed to be
 * extended by {@link com.liferay.faces.crystal.component.selectmanycheckbox.internal.SelectManyCheckboxRenderer} and
 * {@link com.liferay.faces.crystal.component.selectoneradio.internal.SelectOneRadioRenderer}.
 *
